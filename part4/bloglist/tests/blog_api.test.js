...
// test befor token authentication is added
...
describe('manipulate blog', () => {
  ...
  test('a blog can be edited', async() => {
    ...
    await api
      ...
      expect(blogsUpdated).toHaveLength(1)      
      expect(blogsUpdated[0].likes).toEqual(10)
  })
})
